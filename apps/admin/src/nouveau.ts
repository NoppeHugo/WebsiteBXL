...
export const TYPES_COMMERCE = {
  ...
  nail_salon: "Onglerie",
  day_spa: "Spa, centre de bien-être",
  massage: "Massage",
  optician: "Opticien",
  pet_grooming: "Toilettage",
  veterinary: "Cabinet vétérinaire",
  tattoo_parlor: "Tatouage, piercing",
  florist: "Fleuriste",
  bakery: "Boulangerie",

...
const strings = {
  fr: {
    ...
    /* --- La carte, pour les restaurants, cafés et boulangeries. --- */
    menu_title: "La carte",
    tag_vegetarien: "Végétarien",
    tag_vegan: "Vegan",
    tag_sans_gluten: "Sans gluten",
    tag_epice: "Épicé",
    tag_maison: "Fait maison",
    /* --- Le planning des cours. --- */
    schedule_title: "Le planning",
    schedule_with: "avec",
    schedule_places: "places",
    schedule_closed: "Pas de cours",
    /* --- La demande de table. --- */
    table_title: "Réserver une table",
    table_intro:
      "Dites-nous quand, et combien vous êtes. Nous confirmons par téléphone ou par courriel. Rien n'est payé ici.",
    table_date: "Le jour",
    table_time: "L'heure",
    table_party: "Nombre de couverts",
    table_person: "personne",
    table_persons: "personnes",
    table_note: "Une précision ?",
    table_note_help: "Allergies, poussette, anniversaire…",
    table_send: "Demander la table",
    table_ok: "Demande envoyée. Nous vous confirmons la table rapidement.",
    table_ko: "L'envoi a échoué. Appelez-nous, c'est plus sûr.",
    nav_menu: "La carte",
  ...
  nl: {
    ...
    menu_title: "De kaart",
    tag_vegetarien: "Vegetarisch",
    tag_vegan: "Vegan",
    tag_sans_gluten: "Glutenvrij",
    tag_epice: "Pittig",
    tag_maison: "Huisgemaakt",
    schedule_title: "Het rooster",
    schedule_with: "met",
    schedule_places: "plaatsen",
    schedule_closed: "Geen les",
    table_title: "Een tafel reserveren",
    table_intro:
      "Zeg ons wanneer u komt en met hoeveel. Wij bevestigen telefonisch of per e-mail. Hier wordt niets betaald.",
    table_date: "De dag",
    table_time: "Het uur",
    table_party: "Aantal personen",
    table_person: "persoon",
    table_persons: "personen",
    table_note: "Iets toe te voegen?",
    table_note_help: "Allergieën, kinderwagen, verjaardag…",
    table_send: "Tafel aanvragen",
    table_ok: "Aanvraag verstuurd. Wij bevestigen uw tafel snel.",
    table_ko: "Verzenden mislukt. Bel ons, dat is zekerder.",
    nav_menu: "De kaart",
  ...
  en: {
    ...
    schedule_with: "with",
    schedule_places: "spots",
    schedule_closed: "No class",
    table_title: "Book a table",
    table_intro:
      "Tell us when, and how many of you. We confirm by phone or email. Nothing is paid here.",
    table_date: "The day",
    table_time: "The time",
    table_party: "Number of guests",
    table_person: "guest",
    table_persons: "guests",
    table_note: "Anything to add?",
    table_note_help: "Allergies, pushchair, birthday…",
    table_send: "Request the table",
    table_ok: "Request sent. We will confirm your table shortly.",
    table_ko: "Sending failed. Call us, it is safer.",
    nav_menu: "Menu",

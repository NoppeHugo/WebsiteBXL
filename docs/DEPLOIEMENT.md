...
| 2026-09-01 | 7 quinquies | **Le jeu.** Un élève invité en septembre ouvre son espace trois fois, puis plus jamais : le contenu est là, mais rien ne donne de raison d'ouvrir l'application un mercredi soir. C'est sur ce constat qu'un abonnement se résilie. | Points (+10 rendu, +5 acquis, +5 à l'heure), sept paliers, série de jours et huit hauts faits — tous affichés, avec ce qui manque. **Rien n'est donné pour la présence** : ni la connexion ni un brouillon ne rapportent quoi que ce soit, vérifié en vrai (un brouillon n'incrémente pas `jours_actifs`). Le barème est montré à l'élève, un barème secret transformant chaque total en discussion avec le professeur. Migration 012 : seule la liste des jours est stockée, parce que `travaux.rendu_le` ne garde que la dernière remise — un élève qui reprend un vieil exercice aurait vu sa série fondre pour avoir travaillé. |
| 2026-09-01 | 7 quinquies | Le classement de classe motive une partie d'une classe et démoralise l'autre, et personne ne sait laquelle avant de l'avoir allumé. | Éteint par défaut, allumé par le responsable seul, prénoms et initiale du nom. Éteint, la page répond 404 : un élève n'a pas à découvrir qu'un classement existe et lui est refusé. Bascule vérifiée dans les deux sens. |
| 2026-09-01 | 7 ter | L'espace de cours empruntait la feuille de style du commerçant. Or un commerçant ouvre la sienne trois fois par an, debout, une main occupée ; un élève y passe vingt minutes, assis, trois soirs par semaine, souvent lampe éteinte. Une interface conçue pour l'un et servie à l'autre se reconnaît toujours. | Feuille propre, identité indigo, mode sombre, et **aucune ligne de JavaScript** — l'anneau de progression est un cercle SVG dont la longueur est calculée sur le serveur, ce que la politique de sécurité de la console impose de toute façon. Huit pages photographiées dans un vrai navigateur, en clair et en sombre : trois défauts corrigés que la relecture n'avait pas vus (la phrase de la série écrasée en quatre lignes, les titres d'exercices désalignés par la chasse des pictogrammes, et « vu jamais » sur un élève qui venait d'entrer). |
